  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Every step of our process exists to guarantee the purity, safety, and
          premium quality of what reaches you.
        </p>
        {/* <GoldButton onClick={() => navigate("/quality")}>
          Quality Assurance <ArrowRight />
        </GoldButton> */}
      </div>
    </section>
  );
