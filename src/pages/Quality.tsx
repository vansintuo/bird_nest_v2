      ...
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 24px" }}>
        ...
        >
          {STANDARDS.map((s, i) => (
            ...
            >
              <div
                style={{ fontSize: 32, color: C.goldLight, marginBottom: 16 }}
              >
                {s.icon}
              </div>
              <div
...
function Certifications() {
  ...
  const certs = [
    {
      label: "Food Safety",
      sub: "Compliant with food safety handling standards",
    },
    { label: "Hygiene Certified", sub: "Production facility hygiene verified" },
    {
      label: "Natural Product",
      sub: "No artificial additives or bleaching agents",
    },
    {
      label: "Ethical Sourcing",
      sub: "Responsibly harvested from certified farms",
    },
    { label: "Premium Grade", sub: "AAA grade classification standard" },
    {
      label: "Quality Assured",
      sub: "Multi-stage quality inspection protocol",
    },
  ];
  return (
    <section ref={ref} style={{ background: C.ivory, padding: "96px 0" }}>
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 24px" }}>
        <div style={{ textAlign: "center", marginBottom: 64 }}>
          ...
          >
            Placeholder for official certifications — this space is reserved for
            your verified quality credentials.
          </p>
        </div>
        <div
          style={{
  ...
  return (
    <section ref={ref} style={{ background: C.cream }}>
      ...
      >
        ...
        >
          <img
            src="https://images.unsplash.com/photo-1623133894375-ce20135ee521?w=800&h=700&fit=crop&auto=format"
            alt="Quality inspection and preparation"
            style={{
              width: "100%",
              height: "100%",
              objectFit: "cover",
          ...
          <div
            style={{
              position: "absolute",
              inset: 0,
              background: "linear-gradient(to right,transparent 60%,#F2EBE0)",
            }}
          />
        </div>
        ...
        >
          ...
          >
            Before any product is approved for packaging, it passes through our
            five-stage inspection protocol — ensuring nothing leaves our
            facility unless it meets our full standard.
          </p>
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            {CHECKLIST.map((item, i) => (
              ...
              >
                ...
                <span
                  style={{ fontSize: 14, color: C.charcoal, fontWeight: 500 }}
                >
                  {item}
                </span>
              </div>
...
function QualityCTA() {
  ...
  return (
    <section
      ref={ref}
      style={{ background: C.cream, padding: "80px 0", textAlign: "center" }}
    >
      <div
        style={{
          maxWidth: 560,
      ...
      >
        ...
        >
          Our FAQ covers everything about our sourcing, cleaning, and quality
          standards.
        </p>
        <GoldButton onClick={() => navigate("/faq")}>
          View FAQ <ArrowRight />
        </GoldButton>
      </div>
    </section>
      ...
      <section style={{ background: C.ivory, padding: "72px 0" }}>
        ...
        >
          ...
          <p style={{ fontSize: 16, lineHeight: 1.85, color: C.muted }}>
            ...
            partner farm to the second it is sealed in its final packaging,
            every step is guided by our commitment to purity, safety, and
            authenticity. We believe you deserve to know exactly what you are
            receiving, and we are proud to stand behind every product we offer.
          </p>
        </div>
      </section>
